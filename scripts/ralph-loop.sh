#!/usr/bin/env bash
# scripts/ralph-loop.sh — the Backpressure/Ralph loop harness (brings L1–L6
# together). From docs/RALPH_PRODUCTION_GUIDE.md §3.11.2.
#
...
# MIN_FREE_MB, MODEL, BUDGET_USD, MAX_TURNS, ALERT_WEBHOOK.
set -euo pipefail
